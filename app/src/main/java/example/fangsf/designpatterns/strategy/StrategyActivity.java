package example.fangsf.designpatterns.strategy;
...
import example.fangsf.designpatterns.strategy.sample1.FinanceManager;
import example.fangsf.designpatterns.strategy.sample2.AliFinance;
import example.fangsf.designpatterns.strategy.sample2.IFinance;
import example.fangsf.designpatterns.strategy.sample2.WXFinance;
