package example.fangsf.designpatterns.adapter;
...
import example.fangsf.designpatterns.adapter.sample1.IUSDAdapter;
import example.fangsf.designpatterns.adapter.sample1.RMBAdapter;
import example.fangsf.designpatterns.adapter.sample1.USDAdapter;
import example.fangsf.designpatterns.adapter.sample2.ListAdapter;
import example.fangsf.designpatterns.adapter.sample2.ListView;
